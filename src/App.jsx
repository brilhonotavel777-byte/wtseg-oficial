...
const SERVICES = [
  ...
  { icon: "🔄", title: "Rondas Preventivas",      desc: "Vigilância presencial ativa e rondas periódicas para prevenir ocorrências e garantir segurança contínua.", image: "/services/service-05-v2.png" },
  { icon: "📦", title: "Proteção de Ativos",      desc: "Salvaguarda de mercadorias, equipamentos e ativos empresariais com responsabilidade operacional.", image: "/services/service-06.png" },
];
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cdc-btn {
          ...
          background: linear-gradient(135deg, #1dda6b 0%, #16C45B 50%, #12a34c 100%);
          color: #ffffff; padding: 8px 16px; border-radius: 999px;
          text-decoration: none; font-family: inherit; white-space: nowrap;
          box-shadow: 0 0 14px rgba(22,196,91,0.40), 0 4px 14px rgba(0,0,0,0.28);
          transition: transform 0.22s cubic-bezier(0.22,1,0.36,1),
                      box-shadow 0.22s cubic-bezier(0.22,1,0.36,1);
        }
        .cdc-btn:hover {
          transform: scale(1.05);
          box-shadow: 0 0 28px rgba(22,196,91,0.65), 0 6px 22px rgba(0,0,0,0.38);
        }
        .cdc-btn:active { transform: scale(0.98); }
        .cdc-title {
          display: block; font-weight: 700; font-size: 0.68rem;
          letter-spacing: 0.8px; line-height: 1.2; text-transform: uppercase;
        }
        .cdc-sub {
          display: block; font-size: 0.56rem; opacity: 0.88;
          line-height: 1.2; font-weight: 400;
        }
        .cdc-icon { display: flex; align-items: center; flex-shrink: 0; }
        @media (max-width: 1024px) {
          .cdc-sub { display: none; }
          .cdc-btn { padding: 8px 12px; gap: 6px; }
        }
      ...
      <div style={{ background: C.bg, color: C.white, fontFamily: "'Segoe UI', Arial, sans-serif" }}>
        ...
        <header style={{
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="wa-btn cdc-btn"
            aria-label="Central do Cliente - Atendimento via WhatsApp"
          >
            <span className="cdc-icon">
              <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true">
                <path d="M12 2L4 5v6c0 5.55 3.84 10.74 8 12 4.16-1.26 8-6.45 8-12V5l-8-3z"/>
              </svg>
            </span>
            <span>
              <span className="cdc-title">Central do Cliente</span>
              <span className="cdc-sub">Atendimento via WhatsApp</span>
            </span>
            <span className="cdc-icon">
              <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true">
        ...
        <section id="inicio" style={{
          ...
          backgroundImage: isMobile ? "url('/hero5.png')" : "url('/hero6.png')",
